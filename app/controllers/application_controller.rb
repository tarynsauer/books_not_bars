class ApplicationController < ActionController::Base
  # => Intended fix for using <Back> button from /legislators?--- page
  # => Source: http://stackoverflow.com/questions/7734427/rails-3-1-is-returning-raw-javascript-code-when-back-button-is-used
  after_filter do |request|
